...
INSERT INTO public.metadatafieldregistry (metadata_schema_id,"element",qualifier,scope_note)  
Select metadata_schema_id, 'date','embargo','Embargo end date' FROM metadataschemaregistry where short_id = 'dc';

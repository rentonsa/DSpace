...
public interface Consts {
	...
	public static final String SPATIAL_HIJACKED_ELEMENT = MetaDataUtil.SUBJECT_DDC_ELEMENT;

	/** The hijacked DC identifier for spatial coverage */
	public static final String SPATIAL_HIJACKED_IDENTIFIER = MetaDataUtil.SUBJECT_DDC_QUALIFIER;

	/** The full hijacked DC name for spatial coverage */
	public static final String SPATIAL_HIJACKED_NAME = MetadataSchema.DC_SCHEMA + "_" + SPATIAL_HIJACKED_ELEMENT + "_"
